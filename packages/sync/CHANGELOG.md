...
## [0.1.0](https://github.com/sriram687/ZerithDB/compare/zerithdb-sync-v0.0.1...zerithdb-sync-v0.1.0) (2026-05-17)


### Features

* add P2P video conferencing orchestration ([#527](https://github.com/sriram687/ZerithDB/issues/527)) ([0f839eb](https://github.com/sriram687/ZerithDB/commit/0f839eba43629c5fcfdfcd5560e1b771dc045f3a))
...
* **sync:** pause sync loop on tab hide to reduce mobile battery drain ([#305](https://github.com/sriram687/ZerithDB/issues/305)) ([fdcf901](https://github.com/sriram687/ZerithDB/commit/fdcf9018fe6d27bb21c9036c6a35b6be5611cdc4))
* **sync:** re-add zerithdb-utils import after merge ([be50011](https://github.com/sriram687/ZerithDB/commit/be50011bde21b84c5c8321e7efb6fc67b8b7f8e3))
* **sync:** remove duplicate base64 utilities and import from utils ([89ea2c7](https://github.com/sriram687/ZerithDB/commit/89ea2c71a0636baab14c0ee55661fe3f02cbc32a))
* **sync:** replace spread-based bytesToBase64 with loop to prevent RangeError on large arrays ([fc49b02](https://github.com/sriram687/ZerithDB/commit/fc49b02e7e6525cac0acfe0713b5dec9b1fdf75e))
